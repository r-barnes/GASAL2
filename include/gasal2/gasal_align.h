...
#define SEMIGLOBAL_KERNEL_CALL(a,s,h,t,b) \
	case t:\
		{\
		gasal_semi_global_kernel<Int2Type<a>, Int2Type<s>, Int2Type<b>, Int2Type<h>, Int2Type<t>><<<N_BLOCKS, BLOCKDIM, 0, gpu_storage.str>>>(thrust::raw_pointer_cast(gpu_storage.packed_query_batch.data()), thrust::raw_pointer_cast(gpu_storage.packed_target_batch.data()), thrust::raw_pointer_cast(gpu_storage.query_batch_lens.data()), thrust::raw_pointer_cast(gpu_storage.target_batch_lens.data()), thrust::raw_pointer_cast(gpu_storage.query_batch_offsets.data()), thrust::raw_pointer_cast(gpu_storage.target_batch_offsets.data()), gpu_storage.device_res, gpu_storage.device_res_second, gpu_storage.packed_tb_matrices, actual_n_alns);\
		break;\
		}\
...
#define SWITCH_LOCAL(a,s,h,t,b) \
		case s: {\
			...
			if(s == WITH_TB) {\
				...
				gasal_get_tb<Int2Type<LOCAL>><<<N_BLOCKS, BLOCKDIM, 0, gpu_storage.str>>>(thrust::raw_pointer_cast(gpu_storage.unpacked_query_batch.data()), thrust::raw_pointer_cast(gpu_storage.query_batch_lens.data()), thrust::raw_pointer_cast(gpu_storage.target_batch_lens.data()), thrust::raw_pointer_cast(gpu_storage.query_batch_offsets.data()), gpu_storage.packed_tb_matrices, gpu_storage.device_res, gpu_storage.current_n_alns);\
			}\
			break;\
		}\
...
#define SWITCH_GLOBAL(a,s,h,t,b) \
		case s:{\
			gasal_global_kernel<Int2Type<s>><<<N_BLOCKS, BLOCKDIM, 0, gpu_storage.str>>>(thrust::raw_pointer_cast(gpu_storage.packed_query_batch.data()), thrust::raw_pointer_cast(gpu_storage.packed_target_batch.data()), thrust::raw_pointer_cast(gpu_storage.query_batch_lens.data()),thrust::raw_pointer_cast(gpu_storage.target_batch_lens.data()), thrust::raw_pointer_cast(gpu_storage.query_batch_offsets.data()), thrust::raw_pointer_cast(gpu_storage.target_batch_offsets.data()), gpu_storage.device_res, gpu_storage.packed_tb_matrices, actual_n_alns);\
			if(s == WITH_TB) {\
				cudaError_t aln_kernel_err = cudaGetLastError();\
				if ( cudaSuccess != aln_kernel_err )\
				{\
				...
				gasal_get_tb<Int2Type<GLOBAL>><<<N_BLOCKS, BLOCKDIM, 0, gpu_storage.str>>>(thrust::raw_pointer_cast(gpu_storage.unpacked_query_batch.data()), thrust::raw_pointer_cast(gpu_storage.query_batch_lens.data()), thrust::raw_pointer_cast(gpu_storage.target_batch_lens.data()), thrust::raw_pointer_cast(gpu_storage.query_batch_offsets.data()), gpu_storage.packed_tb_matrices, gpu_storage.device_res, gpu_storage.current_n_alns);\
			}\
			break;\
		}\
